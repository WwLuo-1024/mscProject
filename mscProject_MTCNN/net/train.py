...
if __name__ == '__main__':
    # P_NET
    # pnet = Train("pnet", True, False, r"D:\face_recognition\params\p_params.pkl"
    #                  , smpl.p_12txtpath
    #                  , smpl.n_12txtpath
    #                  , smpl.t_12txtpath
    #                  , smpl.p_12imgpath
    ...
    #                  )
    # R_NET
    # rnet = Train("rnet", True, False, r"D:\face_recognition\params\r_params.pkl"
    #                  , smpl.p_24txtpath
    #                  , smpl.n_24txtpath
    #                  , smpl.t_24txtpath
    #                  , smpl.p_24imgpath
    ...
    # O_NET
    onet = Train("onet", True, True, r"D:\face_recognition\params\o_params.pkl"
                 , smpl.p_48txtpath
                 , smpl.n_48txtpath
                 , smpl.t_48txtpath
                 , smpl.p_48imgpath
